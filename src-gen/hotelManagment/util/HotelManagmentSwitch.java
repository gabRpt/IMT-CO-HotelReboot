 ...
 * @generated
 */
public class HotelManagmentSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case HotelManagmentPackage.PERSONNEL: {
			Personnel personnel = (Personnel) theEObject;
			T result = casePersonnel(personnel);
			if (result == null)
		...
		case HotelManagmentPackage.PRESIDENTIELLE: {
			Presidentielle presidentielle = (Presidentielle) theEObject;
			T result = casePresidentielle(presidentielle);
			if (result == null)
				result = caseChambre(presidentielle);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case HotelManagmentPackage.CLASSIQUE: {
			Classique classique = (Classique) theEObject;
			T result = caseClassique(classique);
			if (result == null)
				result = caseChambre(classique);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Personnel</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Personnel</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePersonnel(Personnel object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Presidentielle</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Presidentielle</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePresidentielle(Presidentielle object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Classique</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Classique</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseClassique(Classique object) {
		return null;
	}
